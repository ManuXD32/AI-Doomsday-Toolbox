...
object AiServerNativeContracts {
    fun forServer(type: AiServerType): List<AiServerNativeActionContract> = when (type) {
        ...
        AiServerType.DOCS_DATASETS -> listOf(
            ...
            contract("pdf_translate_ocr", "PDFToolboxScreen guided OCR", "PDFTranslationJobService.enqueue", "PdfOcrJobSpec", "PDFTranslationJobService", "ModelRepository/summary backends", "PDFTranslationLogic.DEFAULT_PAGE_TRANSLATION_SYSTEM_PROMPT"),
            contract("pdf_translate_text_layer", "PDFToolboxScreen guided translation", "PDFTranslationJobService.enqueue", "PdfTextTranslationJobSpec", "PDFTranslationJobService", "ModelRepository/summary backends", "PDFTranslationLogic.DEFAULT_PAGE_TRANSLATION_SYSTEM_PROMPT"),
            ...
            contract("video_summary", "VideoSumupScreen", "VideoRecognitionSummaryService.startConfigured", "VideoRecognitionSummaryRequest + optional audio fallback", "VideoRecognitionSummaryService.state", "VideoRecognitionBundleCatalog + video-capable native chat servers", "VideoRecognitionSettingsRepository + SettingsRepository.videoSummarySettings"),
