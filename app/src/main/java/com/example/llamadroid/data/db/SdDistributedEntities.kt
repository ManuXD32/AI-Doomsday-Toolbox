...
data class SdDistributedMasterSettingsEntity(
    ...
    val imageWidth: String = "512",
    val imageHeight: String = "512",
    val imageSteps: String = "20",
    val imageCfg: String = "7.0",
    val imageSeed: String = "-1",
    val imageSampler: String = "euler_a",
    val imageScheduler: String = "",
    val imageFlowShift: String = "",
    val videoPrompt: String = "",
    val videoNegativePrompt: String = "",
    val videoWidth: String = "480",
    val videoHeight: String = "832",
    val videoSteps: String = "18",
    val videoCfg: String = "6.0",
    val videoSeed: String = "-1",
    val videoSampler: String = "euler",
    val videoScheduler: String = "",
    val videoFlowShift: String = "",
